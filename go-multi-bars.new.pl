...
print SH '/mnt/ilustre/users/ting.kuang/scripts/proteomics/gene-ontology.pl -h r8154 -i '.$upgos.' -l 2 -list '.$uplevel2.' > '.$uplevel2.'.txt'."\n";
print SH '/mnt/ilustre/users/ting.kuang/scripts/proteomics/gene-ontology.pl -h r8154 -i '.$downgos.' -l 2 -list '.$downlevel2.' > '.$downlevel2.'.txt'."\n";
close SH;

...
print PATHWATY "Pathway\tPathway_definition\tNumber_of_protein\tProtein_ko_list\tPathway_image_name\n";
...
#	elsif ($opts{org} eq "gga"){
#		$img_file = $local_img_dir."/gga/".$img_name;
#		$html_file = $local_img_dir."/gga/".$html_name;
#	}
	else{

...
###		}
	...
	close PWD_1;
	## add pathway class
	system "tabletools_add.pl -i /mnt/lustre-2/users/wangyan/rna/database/KEGG/pathwayName_typeII_typeI -t $opts{i}.pathway.xls -n 1 -headt T -headi T > $opts{i}.pathway_addclass.xls";
	system "tabletools_add.pl -i /mnt/lustre-2/users/wangyan/rna/database/KEGG/pathwayName_typeII_typeI -t $opts{i}.disease.xls -n 1 -headt T -headi T > $opts{i}.disease_addclass.xls";
}
...
if(type==\"PATHWAY\"){
	...
	if(nrow(PATHWAY_enrichraw)==0){
		...
		typeII<-c(\"KEGG Pathway Class:\",\"EIP: Environmental Information Processing\",\"GIP: Genetic Information Processing\",\"CP : Cellular Processes\",\"OS : Organismal Systems\",\"M  : Metabolism\")
		### ploting
